          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/pages/gebeden" className="hover:text-[#60c4ff] transition">Gebeden</Link></li>
                <li><Link href="/pages/meditaties" className="hover:text-[#60c4ff] transition">Meditaties</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/pages/faq" className="hover:text-[#60c4ff] transition">Veelgestelde vragen</Link></li>
                <li><Link href="/pages/contact" className="hover:text-[#60c4ff] transition">Contact</Link></li>
                <li><Link href="/pages/privacy" className="hover:text-[#60c4ff] transition">Privacybeleid</Link></li>
              </ul>
            </div>
            <div>
